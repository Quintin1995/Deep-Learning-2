...
Q_DECAY_EPSILON         = 0.9995                         #The maximum epsilon value is multiplied by this number to get a lower epsilon value. (so less chance of a exploratory move happing as max epsilon decreases)
